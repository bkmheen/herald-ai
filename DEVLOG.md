...
## 2026-08-01 — trip-ledger 스킬 신설: 작업 경험의 다중 Mac 공유 (v0.5.0)
...
- 서버 맥: `~/MarvisHome` = 실디렉토리(정본). 리모트 맥: 심볼릭 링크 → `~/Documents/MarvisHome`(수신본).
- `Atelier_OMC/scripts/sync_marvis.sh` 가 `--delete` 로 정본 → iCloud 사본을 rsync.
...
## 2026-07-14 — Windows/WSL CRLF 로 install.sh 실패 수정 (v0.4.1)
...
- README: 특징 목록·설치 단계표·전용 섹션 추가. VERSION/CHANGELOG 0.2.0 반영.
